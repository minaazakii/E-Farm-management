        ...
        <div id="sidenav">
            ...
            <div class="card  " style="background-color: #184D47; border-color:#184D47;  " >
              <div class="row g-0">
                ...
                <div class="row"><a href="#" onclick=" myFunction();" id="pic" ><small>Edit your pic</small></a></div>
              </div>
            </div>
                    ...
                    <a href="start.html"  class="list-group-item list-group-item-action" style="color:#184D47"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-rss" viewBox="0 0 16 16">
